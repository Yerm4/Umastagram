...
if (postForm && postMessage) {
    postForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            if (data.status === "ok") {
                const postsWrap = document.querySelector(".post-wrapper");
                const newPost = crearPost(data.data);
            
                postsWrap.prepend(newPost); 
...
function crearPost(data) {
    ...
    postDiv.innerHTML = `
        ...
        <div class="post__interaction">
            ...
            <svg class="post__interaction-like" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
