        ...
        <main id="main" class="home" data-login='<?php echo isset($_SESSION["user_id"]) ? "true" : "false" ?>'>
            <section class="hero establo" id="hero">
                    <div class="hero__container">
                        ...
                        <div class="irl-button anim-appear" id="switch-button" >
                            <svg class="irl-button__horse-icon" id="irl-button__horse-icon" viewBox="0 0 286.8 286.8" fill="#000" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="irl-button__uma-icon" id="irl-button__uma-icon" viewBox="0 0 48 48" fill="none" stroke="#000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
            ...
            <section class="available-section">
                <div>
                    ...
                    <div class="available-section__grid" id="available-section__grid">
