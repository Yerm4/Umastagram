            ...
            <section class="hero establo" id="hero">
                    <div class="hero__container">
                        ...
                        <div class="irl-button anim-appear" id="switch-button" >
                            ...
                            <svg class="irl-button__uma-icon" id="irl-button__uma-icon" viewBox="0 0 48 48" fill="none" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
