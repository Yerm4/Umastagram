<dialog name="modal" id="loginModal">
    <svg class="modal__close-icon" id="closeModalLogin" data-modal="loginModal" fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 460.775 460.775" xml:space="preserve">
    ...
    <div class="card login-card">
        ...
        <p id="loginMessage" class="form__warning"><?php echo isset($_SESSION["login_error"]) ? e($_SESSION["login_error"]) : ""; unset($_SESSION["login_error"]) ?></p>
    </div>
    <a href="#" class="modal__switch-link" id="switchToRegistro">
